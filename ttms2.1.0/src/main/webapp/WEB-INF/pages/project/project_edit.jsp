...
<form  class="form-horizontal" role="form" id="editFormId">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
		<input type="text" class="form-control datepicker " name="beginDate" id="beginDateId">
		</div>
	</div>
	<div class="form-group">
		<label for="project-code" class="col-sm-2 control-label">结束时间:</label> 
		<div class="col-sm-10">
		<input type="text" class="form-control datepicker "  name="endDate" id="endDateId">
		</div>
	</div>
	<div class="form-group">
...
<script type="text/javascript" src="${url}"></script>ml>